 ...
 * @version: 
 * @Author: zhangyuehai
 * @Date: 2022-06-23 11:18:53
 * @LastEditors: zhangyuehai
 * @LastEditTime: 2022-06-29 09:23:29
 */
...
export default {
  ...
  updateTeamList(state, teams) {
    const nim = state.nim
    console.log(store.state.teamlist);
  ...
  changeDownLoadMessage(state,obj){
    console.log(state.downLoadMessage,'zzzzz');
    state.downLoadMessage ={...state.downLoadMessage,...obj}
  }
}
